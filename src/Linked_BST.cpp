...
void Linked_BST::addBST(int data)
{
...
void Linked_BST::removeBST(int key)
{
    if (isEmpty())
    {
        throw "Tree is empty";
...
void Linked_BST::heapify(Node *node)
{
    if (node == nullptr)
    {
        return;
...
Node *Linked_BST::getSuccessor(Node *node)
{
...
int Linked_BST::searchBST(int key)
{
    Node *current = root;
    if (isEmpty())
    {
